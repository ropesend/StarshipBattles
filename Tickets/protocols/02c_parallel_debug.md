...
- **Bug tickets** (`Debugging/active_bugs/BUG-XX.md`): Workers update Work Logs. Coordinator updates status.
- **Dashboard** (`Debugging/debug_plan.md`): Coordinator updates after each successful merge.
