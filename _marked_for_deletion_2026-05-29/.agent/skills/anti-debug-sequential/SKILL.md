---
name: anti-debug-sequential
description: Fix multiple bugs sequentially without parallel tracking (e.g., /anti-debug-sequential 85 86 87 or /anti-debug-sequential all)
