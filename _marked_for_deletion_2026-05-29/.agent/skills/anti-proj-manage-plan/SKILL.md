...
- **ADD**: Add a new project. Specify Title and Priority.
- **REMOVE**: Remove or archive a project. Specify Delete / Archive / Skip.
- **UPDATE**: Synchronize project details from its source plan.
- **REORDER**: Move a project to a new position in the master list.
...
- [ ] No orphaned text or formatting artifacts.
- [ ] Ordering respects project dependencies.
