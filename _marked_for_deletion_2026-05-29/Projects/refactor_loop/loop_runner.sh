...
while [ $iteration -lt $MAX_ITERATIONS ]; do
    ...
    # Use --system-prompt-file to load Projects/refactor_loop/WORKER.md instead of CLAUDE.md
    ...
    # This includes:
    # - Reading Projects/refactor_loop/refactor_plan.md
    ...
    claude \
        ...
        -p "Follow Protocol 08 (Automated Loop). Read Projects/refactor_loop/refactor_plan.md. Execute next work item (phase or audit). Update plan. Commit. Exit." \
        || {
...
log_info "Check Projects/refactor_loop/refactor_plan.md Agent Context for details"
exit 1
