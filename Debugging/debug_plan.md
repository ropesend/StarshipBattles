...
| BUG-63 | 2026-02-07 | Starting planet should match species ideal conditions | In-Progress | [BUG-63.md](active_bugs/BUG-63.md) |
...
| BUG-87 | 2026-02-11 | Empire Treasury window missing colony resource production totals | Pending | [BUG-87.md](active_bugs/BUG-87.md) |
| BUG-88 | 2026-02-11 | Empire Population tab blank - missing species information cards | Pending | [BUG-88.md](active_bugs/BUG-88.md) |

## 3. Current Focus: None
**Status:** 9 new bugs ingested (BUG-80 through BUG-88). No active work in progress.
