...
loop_runner.sh                # Main automation loop
...
### 1. Master Plan (`refactor_plan.md`)
...
```bash
python Projects/scripts/check_completion.py refactor_plan.md
...
```bash
# Mark phase complete
python Projects/scripts/update_plan.py mark-complete refactor_plan.md PROJ-45 1

# Update agent context
python Projects/scripts/update_plan.py update-context refactor_plan.md \
    "PROJ-45 Phase 1" "Ready for Phase 2" "5199 passed"

# Add execution log entry
python Projects/scripts/update_plan.py add-log refactor_plan.md \
...
2. **Claude starts** → Reads `refactor_plan.md`
...
8. **Claude updates** → Marks phase `[x]` in `refactor_plan.md`
...
Edit `refactor_plan.md` to reorder projects/phases as needed. The system executes tasks in order from top to bottom.
...
Open `refactor_plan.md` and scroll to "Execution Log" table.
...
**Check:** `refactor_plan.md` Agent Context for blockers
...
- [ ] All tests passing
- [ ] Git state clean
- [ ] Projects ordered correctly in `refactor_plan.md`
- [ ] Sufficient disk space for git history

### During Execution

- Monitor terminal output periodically
- Check `refactor_plan.md` Agent Context for issues
...
Edit `refactor_plan.md` to comment out other projects:
```markdown
...
# Edit refactor_plan.md to only include PROJ-42
./loop_runner.sh
```
...
|------|---------|-------------|
| `refactor_plan.md` | Master task list | Claude (automated) |
| `CLAUDE.md` | Rules for Claude | Manual (setup) |
| `loop_runner.sh` | Main loop script | Manual (setup) |
| `check_completion.py` | Task completion checker | Loop script |
| `update_plan.py` | Plan updater | Claude (optional) |
| `commit_phase.py` | Git commit helper | Claude (optional) |
...
1. This README
2. `CLAUDE.md` rules
3. `refactor_plan.md` Agent Context
