...
from ship import VALIDATOR, LayerType
...
class TestBuilderDragDropReal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        p_right = patch('builder_gui.BuilderRightPanel')
        self.MockRightPanel = p_right.start()
        self.patchers.append(p_right)
        
        p_detail = patch('builder_gui.ComponentDetailPanel')
        ...
        p_btn = patch('builder_gui.UIButton')
        self.MockUIButton = p_btn.start()
        self.patchers.append(p_btn)
        
        p_panel = patch('builder_gui.UIPanel')
