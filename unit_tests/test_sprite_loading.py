...
class TestSpriteLoading(unittest.TestCase):
    ...
    @patch('sprites.os.path.exists')
    @patch('sprites.os.listdir')
    @patch('sprites.pygame.image.load')
    def test_load_sprites_from_directory(self, mock_load, mock_listdir, mock_exists):
        ...
        expected_path_1 = os.path.join(base_path, "Resources", "Images", "Components", "Tiles", "Comp_001.bmp")
