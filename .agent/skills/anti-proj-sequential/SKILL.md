---
name: anti-proj-sequential
description: Execute multiple projects sequentially without parallel isolation (e.g., /anti-proj-sequential PROJ-86 PROJ-87 or /anti-proj-sequential all)
...
- Run `/anti-proj-reset-baseline` or identical `Tools/test_sharded/test_sharded.py` validations.
