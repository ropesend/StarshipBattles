...
### 6. CRITICAL: Inconsistent DI Pattern - Some Services Require Provider, Others Allow None
**ID:** CON-UI2-001
...
**Impact:** Callers cannot reason about which services require explicit DI. VehicleClassService fails at construction time if not given a provider; ComponentS...

---

### 7. CRITICAL: String-to-Enum Migration Support Code in BattleEngine
**ID:** LEG-SIM-001
**Agent:** Legacy Simulation
...
**Impact:** This backward compatibility layer suggests some code path is still passing string attack types instead of using the proper `AttackType...

---

### 8. CRITICAL: Backward Compatibility Aliases in RacePortraitGallery
**ID:** LEG-UI1-001
**Agent:** Legacy Ui Screens
...
**Location:** `game/simulation/entities/projectile.py`
**Effort:** Medium
...
**Impact:** Projectile physics bugs (speed, tracking, collision) would go undetected. Seeker missiles, torpedoes, and other guided m...
...
**Impact:** These methods directly affect combat calculations (hit/miss, damage). Stack group aggregation rules (MA...
...
---
*Report generated: 2026-02-13 00:47*
