...
# TestShipStatsCargoStorage moved to tests/unit/strategy/services/test_ship_stats_cargo_storage.py
# (ShipStatsCalculator is strategy-layer code, not simulation-layer)
