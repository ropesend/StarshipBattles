...
- [x] Change `**Status:** Complete` to `**Status:** Complete` at line 8
- [x] Check all 34 task boxes (`- [x]` → `- [x]`) across Tasks 1.1 through 1.5
- [x] In each task's `**Notes:**` line, add a one-line attribution: `Shipped via commit 0ec916cae (PROJ-314 Phase 1).`
- [x] At the bottom of the Phase Completion Checklist section, check all 4 boxes
- [x] Verify: `git log -1 0ec916cae` shows the expected commit summary

**Notes:** Completed; `validate_audit_ready.py PROJ-314` now exits 0 with all phases complete and no blockers.
...
- [x] Create file with header `# Phase 2: New game/ui/services/image/ service`
- [x] Add `**Status:** Complete` and `**Objective:** Create the new image-generation service mirroring game/services/llm/.`
- [x] Add a "Tasks" section listing the 7 service files and 5 test files PROJ-314 actually shipped (cross-reference `Projects/active_projects/PROJ-314/manifest.md`):
...
- [x] Add `**Notes:** Shipped via commit 62a7c05af.` to each task
- [x] Phase Completion Checklist at the bottom — all boxes checked
...
- [x] Create file with header `# Phase 3: Loader rewrite`
- [x] `**Status:** Complete`
- [x] Tasks listing the actual changes:
...
- [x] All boxes checked; `**Notes:** Shipped via commit 48de788da.`
...
- [x] Header `# Phase 4: Image generation tool + asset prep`
- [x] Status `Complete`
- [x] Tasks: CLI tool creation, audit script, prompt templates, 151 .jpg→.png conversions, filename normalization across 8 themes, Atlantians typo fix, Thoraliens path mismatch fix
- [x] All boxes checked; `**Notes:** Shipped via commit d000acc5a. AI portrait generation deferred — user runs CLI with their OPENAI_API_KEY.`
...
- [x] Header `# Phase 5: Atomic schema migration`
- [x] Status `Complete`
- [x] Tasks: 9 theme.json files migrated to new schema; 4 hardcoded-convention sites updated; new integration smoke test added
- [x] All boxes checked; `**Notes:** Shipped via commit 0bbf9c36d.`
...
- [x] Header `# Phase 6: Cleanup + documentation`
- [x] Status `Complete`
- [x] Tasks: legacy .jpg deletions, `docs/01_ARCHITECTURE.md` updated, `docs/03_CONVENTIONS.md` §11 added, `Last verified:` dates bumped
- [x] All boxes checked; `**Notes:** Shipped via commit e26f00f74. Note: docs/02_PATTERNS.md, docs/README.md, AGENTS.md were not updated; this is addressed by PROJ-318 Phase 2.`
...
- [x] Run the script with the venv Python (`.venv/Scripts/python.exe`)
- [x] Capture the full output
- [x] Confirm exit code 0 and zero errors
- [x] If any failures remain, iterate on the previous tasks
...
- [x] `python Projects/scripts/validate_audit_ready.py PROJ-314` exits 0
- [x] PROJ-314 plan.md Current State updated to acknowledge PROJ-318 closeout
- [x] Update status at top of this file to `Complete`
- [x] Update plan.md phase table row to `Complete`
- [x] Update plan.md Current State to point to Phase 2
- [x] Commit: `chore(PROJ-318 Phase 1): retroactive PROJ-314 phase checklists + audit-gate fix`
