---
name: claude-debug-parallel
description: Fix multiple bugs in parallel using coordinated agents with file-level conflict avoidance (e.g., /claude-debug-parallel 85 86 87 or /claude-debug-parallel all)
...
2. **If SUCCESS:**
   ...
   b. Run tests: `python Tools/test_sharded/test_sharded.py`
   c. If tests pass:
