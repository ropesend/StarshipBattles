...
Default priority is **Medium**. The user can adjust later via `/proj-manage-plan`.
...
- Remind: "Use `/proj-manage-plan REORDER` to adjust priority or ordering"
