...
CONFIRMED_FILE = TRACKING_DIR / "confirmed_features.txt"
FEATURE_PLAN_PATH = TRACKING_DIR / "feature_plan.md"
COMPLETED_FEATURES_PATH = TRACKING_DIR / "completed_features.md"
ACTIVE_FEATURES_DIR = TRACKING_DIR / "features" / "active"
ARCHIVED_DIR = TRACKING_DIR / "features" / "archived"
