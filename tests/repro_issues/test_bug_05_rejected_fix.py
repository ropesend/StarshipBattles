...
def test_usage_only_visibility(fresh_registries):
    """
...
def test_max_usage_calculation(fresh_registries):
    """
    ...
    ship = Ship(name="TestShip2", x=0, y=0, color=(255, 255, 255), ship_class="TestClass", registries=fresh_registries)
