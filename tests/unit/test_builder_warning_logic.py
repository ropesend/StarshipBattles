...
class TestBuilderWarningLogic(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch('game.ui.screens.builder.main.BuilderSceneGUI._create_ui')
        self.mock_create_ui = self.patcher.start()
        self.addCleanup(self.patcher.stop)
        
        # Mock internal managers
        self.p1 = patch('game.ui.screens.builder.main.SpriteManager')
        self.p2 = patch('game.ui.screens.builder.main.PresetManager')
        self.p3 = patch('game.ui.screens.builder.main.ShipThemeManager')
        self.p4 = patch('game.ui.screens.builder.main.UIConfirmationDialog')
    ...
    def test_change_type_empty_ship(self):
        ...
        with patch('game.simulation.entities.ship.VEHICLE_CLASSES', {'Station': {'type': 'Station', 'max_mass': 5000}}):
            with patch.object(self.builder, '_execute_pending_action') as mock_execute:
                self.builder.handle_event(event)
