...
class TestFleetBattleAdapter:
    ...
    def test_to_battle_ships_converts_instances(self):
    ...
    def test_to_battle_ships_skips_non_combat(self):
    ...
    def test_to_battle_ships_custom_positions(self):
    ...
    def test_update_from_battle_results_survivors(self):
        ...
        ship2 = make_ship_instance(name="Destroyed", design_data={})
    ...
    def test_update_from_battle_results_all_destroyed(self):
    ...
    def test_update_from_battle_results_triggers_speed_recalc(self):
