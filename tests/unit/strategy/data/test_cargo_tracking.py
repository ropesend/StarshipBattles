...
class TestShipInstanceCargoCapacity:
    """Tests for ShipInstance._cargo_mgr.get_cargo_capacity()."""

    def test_ship_instance_cargo_capacity(self, ship_with_cargo_capacity):
        """Test reading cargo capacity from calculated stats."""
        capacity = ship_with_cargo_capacity._cargo_mgr.get_cargo_capacity('passengers')
    ...
    def test_ship_instance_cargo_capacity_generic(self, ship_with_cargo_capacity):
        ...
        capacity = ship_with_cargo_capacity._cargo_mgr.get_cargo_capacity('generic')
    ...
    def test_ship_instance_cargo_capacity_missing_type(self, ship_with_cargo_capacity):
        ...
        capacity = ship_with_cargo_capacity._cargo_mgr.get_cargo_capacity('fuel_pods')
        assert capacity == 0
    ...
    def test_ship_instance_cargo_capacity_no_cargo_ship(self, ship_without_cargo):
        ...
        capacity = ship_without_cargo._cargo_mgr.get_cargo_capacity('passengers')
        assert capacity == 0


class TestShipInstanceLoadCargo:
    """Tests for ShipInstance._cargo_mgr.load_cargo()."""

    def test_ship_instance_load_cargo(self, ship_with_cargo_capacity):
        """Test basic cargo loading."""
        loaded = ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 1000)
        assert loaded == 1000
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('passengers') == 1000
    ...
    def test_ship_instance_load_cargo_multiple_times(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 1000)
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 500)
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('passengers') == 1500

    def test_ship_instance_load_over_capacity(self, ship_with_cargo_capacity):
        """Test loading more than capacity is capped."""
        loaded = ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 10000)
        assert loaded == 5000  # Capped at capacity
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('passengers') == 5000
    ...
    def test_ship_instance_load_partial_over_capacity(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 4000)
        loaded = ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 3000)
    ...
    def test_ship_instance_load_no_capacity(self, ship_without_cargo):
        ...
        loaded = ship_without_cargo._cargo_mgr.load_cargo('passengers', 100)
        assert loaded == 0
    ...
    def test_ship_instance_load_different_cargo_types(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 2000)
        ship_with_cargo_capacity._cargo_mgr.load_cargo('generic', 500)
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('passengers') == 2000
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('generic') == 500


class TestShipInstanceUnloadCargo:
    """Tests for ShipInstance._cargo_mgr.unload_cargo()."""

    def test_ship_instance_unload_cargo(self, ship_with_cargo_capacity):
        """Test basic cargo unloading."""
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 3000)
        unloaded = ship_with_cargo_capacity._cargo_mgr.unload_cargo('passengers', 1000)
    ...
    def test_ship_instance_unload_more_than_current(self, ship_with_cargo_capacity):
        ...
        assert ship_with_cargo_capacity._cargo_mgr.get_current_cargo('passengers') == 0

    def test_ship_instance_unload_empty_cargo(self, ship_with_cargo_capacity):
        """Test unloading from empty cargo returns 0."""
        unloaded = ship_with_cargo_capacity._cargo_mgr.unload_cargo('passengers', 100)
        assert unloaded == 0
    ...
    def test_ship_instance_unload_clears_zero_entry(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 100)
        ship_with_cargo_capacity._cargo_mgr.unload_cargo('passengers', 100)
...
class TestShipInstanceCargoSpaceAvailable:
    """Tests for ShipInstance._cargo_mgr.get_cargo_space_available()."""

    def test_cargo_space_available_empty(self, ship_with_cargo_capacity):
        """Test available space when empty."""
        available = ship_with_cargo_capacity._cargo_mgr.get_cargo_space_available('passengers')
    ...
    def test_cargo_space_available_full(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 5000)
        available = ship_with_cargo_capacity._cargo_mgr.get_cargo_space_available('passengers')
        assert available == 0
...
class TestShipInstanceCargoSerialization:
    ...
    def test_ship_instance_cargo_serialization_roundtrip(self, ship_with_cargo_capacity):
        ...
        ship_with_cargo_capacity._cargo_mgr.load_cargo('passengers', 2500)
        ship_with_cargo_capacity._cargo_mgr.load_cargo('generic', 750)
        ...
        assert restored._cargo_mgr.get_current_cargo('generic') == 750
...
class TestFleetLoadCargo:
    ...
    def test_fleet_load_distributes_across_ships(self, fleet_with_cargo_ships):
        ...
        total = ship1._cargo_mgr.get_current_cargo('passengers') + ship2._cargo_mgr.get_current_cargo('passengers')
        assert total == 6000
...
class TestFleetUnloadCargo:
    ...
    def test_fleet_unload_from_multiple_ships(self, fleet_with_cargo_ships):
        ...
        fleet_with_cargo_ships.ships[0]._cargo_mgr.load_cargo('passengers', 3000)
