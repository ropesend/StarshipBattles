...
def _make_pursuer_fleet(fleet_id, location=None):
...
class TestAddRemovePursuer:
    ...
    def test_add_and_remove_pursuer(self):
        target = _make_pursuer_fleet("target")
        pursuer = _make_pursuer_fleet("pursuer")
...
class TestRedirectPursuers:
    ...
    def test_redirect_pursuers_rewrites_order_targets(self):
        old_target = _make_pursuer_fleet("old_target")
        new_target = _make_pursuer_fleet("new_target")
        pursuer_a = _make_pursuer_fleet("pursuer_a")
        pursuer_b = _make_pursuer_fleet("pursuer_b")
    ...
    def test_redirect_preserves_non_targeting_orders(self):
        old_target = _make_pursuer_fleet("old_target")
        new_target = _make_pursuer_fleet("new_target")
        other_fleet = _make_pursuer_fleet("other")
        pursuer = _make_pursuer_fleet("pursuer")
...
class TestMergeWithRedirect:
    ...
    def test_merge_with_redirects_pursuers(self):
        ...
        fleet_a = _make_pursuer_fleet("a")
        fleet_b = _make_pursuer_fleet("b")
        fleet_c = _make_pursuer_fleet("c")
    ...
    def test_merge_with_multiple_pursuers(self):
        ...
        target = _make_pursuer_fleet("target")
        new_target = _make_pursuer_fleet("new_target")
        pursuers = [_make_pursuer_fleet(f"p{i}") for i in range(3)]
...
class TestNotifyTargetDestroyed:
    ...
    def test_notify_target_destroyed_preserves_other_orders(self):
        target = _make_pursuer_fleet("target")
        other = _make_pursuer_fleet("other")
        pursuer = _make_pursuer_fleet("pursuer")
...
class TestRedirectPursuersExcludeKwarg:
    ...
    def test_redirect_excludes_specified_fleet_from_rewrite(self):
        ...
        old_target = _make_pursuer_fleet("old_target")
        new_target = _make_pursuer_fleet("new_target")
        normal_pursuer = _make_pursuer_fleet("normal_pursuer")
