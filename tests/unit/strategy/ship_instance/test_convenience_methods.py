...
class TestResourceMethodInteractions:
    ...
    def test_get_resource_capacity_with_disabled_component(self, make_ship_with_stats):
...
class TestResupply:
    ...
    def test_resupply_uses_resource_storage_not_max_key(self, make_ship_with_stats):
