...
class TestIsModifierAllowed:
    ...
    def test_simple_size_mount_allowed_for_all(self, weapon_component, engine_component):
        ...
        assert service.is_modifier_allowed('simple_size_mount', weapon_component)
        assert service.is_modifier_allowed('simple_size_mount', engine_component)

    def test_turret_mount_allowed_for_weapon(self, weapon_component):
        """turret_mount should be allowed for weapon components."""
        service = ModifierService()
        assert service.is_modifier_allowed('turret_mount', weapon_component)
    ...
    def test_turret_mount_not_allowed_for_engine(self, engine_component):
        ...
        service = ModifierService()
        assert not service.is_modifier_allowed('turret_mount', engine_component)
    ...
    def test_range_mount_allowed_for_projectile_weapon(self, weapon_component):
        ...
        result = service.is_modifier_allowed('range_mount', weapon_component)
    ...
    def test_range_mount_not_allowed_for_seeker(self, seeker_component):
        ...
        service = ModifierService()
        if seeker_component:
            assert not service.is_modifier_allowed('range_mount', seeker_component)

    def test_nonexistent_modifier_not_allowed(self, weapon_component):
        """Non-existent modifier should not be allowed."""
        service = ModifierService()
        assert not service.is_modifier_allowed('nonexistent_modifier_xyz', weapon_component)
    ...
    def test_hardened_not_allowed_for_armor(self, armor_component):
        ...
        service = ModifierService()
        assert not service.is_modifier_allowed('hardened', armor_component)
...
class TestGetMandatoryModifiers:
    ...
    def test_simple_size_always_mandatory(self, weapon_component, engine_component, armor_component):
        ...
        service = ModifierService()
        assert 'simple_size_mount' in service.get_mandatory_modifiers(weapon_component)
        assert 'simple_size_mount' in service.get_mandatory_modifiers(engine_component)
        assert 'simple_size_mount' in service.get_mandatory_modifiers(armor_component)

    def test_weapon_gets_facing_mandatory(self, weapon_component):
        """Weapon components should have facing as mandatory."""
        service = ModifierService()
        mandatory = service.get_mandatory_modifiers(weapon_component)
    ...
    def test_engine_does_not_get_weapon_modifiers(self, engine_component):
        ...
        service = ModifierService()
        mandatory = service.get_mandatory_modifiers(engine_component)
    ...
    def test_seeker_gets_seeker_modifiers(self, seeker_component):
        ...
        if seeker_component and seeker_component.has_ability('SeekerWeaponAbility'):
            mandatory = service.get_mandatory_modifiers(seeker_component)
...
class TestGetInitialValue:
    ...
    def test_turret_mount_initial_value_uses_base_arc(self, weapon_component):
        ...
        service = ModifierService()
        value = service.get_initial_value('turret_mount', weapon_component)
    ...
    def test_nonexistent_modifier_returns_zero(self, weapon_component):
        ...
        service = ModifierService()
        value = service.get_initial_value('nonexistent_modifier_xyz', weapon_component)
        assert value == 0
...
class TestEnsureMandatoryModifiers:
    ...
    def test_adds_missing_mandatory_modifiers(self, weapon_component):
        ...
        service.ensure_mandatory_modifiers(weapon_component)
...
class TestGetLocalMinMax:
    ...
    def test_returns_tuple(self, weapon_component):
        ...
        service = ModifierService()
        result = service.get_local_min_max('simple_size_mount', weapon_component)
    ...
    def test_simple_size_mount_range(self, weapon_component):
        ...
        service = ModifierService()
        min_val, max_val = service.get_local_min_max('simple_size_mount', weapon_component)
        assert min_val == 1.0
    ...
    def test_facing_range(self, weapon_component):
        ...
        service = ModifierService()
        min_val, max_val = service.get_local_min_max('facing', weapon_component)
        assert min_val == 0.0
    ...
    def test_turret_mount_min_uses_base_arc(self, weapon_component):
        ...
        service = ModifierService()
        min_val, max_val = service.get_local_min_max('turret_mount', weapon_component)
        assert min_val >= 0
    ...
    def test_nonexistent_modifier_returns_default(self, weapon_component):
        ...
        service = ModifierService()
        min_val, max_val = service.get_local_min_max('nonexistent_modifier_xyz', weapon_component)
        assert min_val == 0
        assert max_val == 100
    ...
    def test_range_mount_range(self, weapon_component):
        ...
        service = ModifierService()
        min_val, max_val = service.get_local_min_max('range_mount', weapon_component)
        assert min_val == 0.0
        assert max_val == 3.0
