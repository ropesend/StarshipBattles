...
@pytest.fixture
def service():
    """Create a ShipBuilderService instance with loaded data."""
    # reset_game_state autouse fixture ensures registry is populated
    return ShipBuilderService()


class TestShipBuilderServiceCreateShip:
    """Tests for ShipBuilderService.create_ship()."""
...
class TestShipBuilderServiceAddComponent:
    """Tests for ShipBuilderService.add_component()."""
...
class TestShipBuilderServiceRemoveComponent:
    """Tests for ShipBuilderService.remove_component()."""
...
class TestShipBuilderServiceChangeClass:
    """Tests for ShipBuilderService.change_class()."""
...
class TestShipBuilderServiceValidateDesign:
    """Tests for ShipBuilderService.validate_design()."""
...
class TestShipBuilderServiceGetAvailableComponents:
    """Tests for ShipBuilderService.get_available_components()."""
...
class TestShipBuilderResult:
    """Tests for ShipBuilderResult dataclass."""

    def test_result_success_properties(self):
        """ShipBuilderResult stores success information correctly."""
        result = ShipBuilderResult(success=True)
    ...
    def test_result_failure_with_errors(self):
        """ShipBuilderResult stores error information correctly."""
        result = ShipBuilderResult(
            success=False,
