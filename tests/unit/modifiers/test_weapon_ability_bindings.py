...
# ---------------------------------------------------------------------------
# BeamWeaponAbility — merged from former test_beam_weapon_bindings.py.
# BeamWeaponAbility extends WeaponAbility with one additional ACCURACY_ADD
# binding; only the accuracy-related cases are kept here.
# ---------------------------------------------------------------------------
