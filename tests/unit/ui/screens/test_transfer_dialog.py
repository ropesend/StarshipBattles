...
class TestTransferDialog:
    ...
    def test_source_change_updates_targets(self, mock_manager, mock_scene, mock_fleet):
        ...
        f2 = MagicMock(id=2, owner_id=0)
        mock_scene.facade.get_fleets_at_hex.return_value = [f1, f2]
        mock_scene.facade.get_planets_at_hex.return_value = []
    ...
    def test_update_cargo_list_for_colony(self, mock_manager, mock_scene, mock_fleet):
        ...
        # Arrange
        mock_scene.facade.get_fleets_at_hex.return_value = [mock_fleet]
        # Colony ID 10
        p1 = MagicMock(planet_id=10, owner_id=0)
        p1.name = "Alpha"
        mock_scene.facade.get_planets_at_hex.return_value = [p1]
        
        # Mock FleetInfo DTO
        dummy_f_info = MagicMock(spec=FleetInfo)
        dummy_f_info.passengers_current = 0
        mock_scene.facade.get_fleet.return_value = dummy_f_info
        ...
        mock_scene.facade.get_planet.return_value = mock_planet_info
    ...
    def test_issue_order_dispatches_command(self, mock_manager, mock_scene, mock_fleet):
        ...
        mock_scene.facade.get_fleet.return_value = mock_fleet_info
        ...
        with patch('game.ui.screens.transfer_dialog.IssueTransferCommand') as mock_cmd_class:
            ...
            mock_scene.facade.handle_command.assert_called_once()
