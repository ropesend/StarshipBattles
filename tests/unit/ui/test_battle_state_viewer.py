"""
Unit tests for ui/battle_state_viewer.py

Tests the JSON diff computation, path marking, and viewer logic.
Focuses on pure logic testing without pygame_gui initialization.
"""
import pytest
