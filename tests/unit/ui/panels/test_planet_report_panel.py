...
# ---------------------------------------------------------------------------
# QA-OBS-A: the staged-units side column was removed; staging-yard contents
# now render inline within the planet info text via `format_planet_info`.
# The orphaned `TestStagedUnitsList` suite that pinned the side-column
# behavior was deleted. Inline coverage lives in
# `tests/unit/ui/screens/test_strategy_detail_fmt.py::TestFormatPlanetInfo`
# under the `staging_yard` tests.
# ---------------------------------------------------------------------------
