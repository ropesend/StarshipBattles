class TestModifierLogic:
    ...
    def test_turret_decrement_90(self):
        ...
        assert self.calculate_snap_decrement(11, 90, 0) == 0
        # if it is 45 then it should go to 0
        assert self.calculate_snap_decrement(45, 90, 0) == 0
        # if it is 117 then it would go to 90
        assert self.calculate_snap_decrement(117, 90, 0) == 90
        # Implicit: if 90 to 0
        assert self.calculate_snap_decrement(90, 90, 0) == 0

    def test_turret_decrement_15(self):
        # if it were 17 then it would go to 15
        assert self.calculate_snap_decrement(17, 15, 0) == 15
        # if it were 115 then it would go to 105
        assert self.calculate_snap_decrement(115, 15, 0) == 105

    def test_turret_increment_15(self):
        # if it were 22 then it would go to 30
        assert self.calculate_snap_increment(22, 15, 360) == 30
        # if it were 177 then it would go to 180
        assert self.calculate_snap_increment(177, 15, 360) == 180
        # Exact multiple?
        assert self.calculate_snap_increment(30, 15, 360) == 45

    def test_size_decrement(self):
        # 100 step (Snap Floor 100)
        # 376 -> 300
        assert self.calculate_snap_decrement(376, 100, 1) == 300
        # 300 -> 200
        assert self.calculate_snap_decrement(300, 100, 1) == 200
        # 147 -> 100
        assert self.calculate_snap_decrement(147, 100, 1) == 100
        ...
        assert self.calculate_size_decrement(100, 100, 1) == 1
        assert self.calculate_size_decrement(50, 100, 1) == 1

        # 10 step (Snap Floor 10)
        # 376 -> 370
        assert self.calculate_snap_decrement(376, 10, 1) == 370
        # 87 -> 80
        assert self.calculate_snap_decrement(87, 10, 1) == 80
    ...
    def test_size_increment(self):
        ...
        # 147 -> 200
        assert self.calculate_snap_increment(147, 100, 1024) == 200
        # 150 -> 200
        assert self.calculate_snap_increment(150, 100, 1024) == 200

        # 10 step (Snap Ceil 10)
        # 147 -> 150
        assert self.calculate_snap_increment(147, 10, 1024) == 150
