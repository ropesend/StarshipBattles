...
class TestDetailPanelRendering(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.uipanel_patch = patch('game.ui.screens.builder.detail_panel.UIPanel')
        self.uilabel_patch = patch('game.ui.screens.builder.detail_panel.UILabel')
        self.uiimage_patch = patch('game.ui.screens.builder.detail_panel.UIImage')
        self.uibutton_patch = patch('game.ui.screens.builder.detail_panel.UIButton')
