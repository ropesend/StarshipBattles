"""
Unit tests for ShipControllableAdapter implementation.

Tests the adapter that wraps Ship for IControllable interface.
Split from test_controllable_interface.py - adapter implementation tests.
"""
