...
from game.simulation.systems.validator import ShipDesignValidator, ValidationResult
...
class TestBridgeRequirementRemoval(unittest.TestCase):
    def setUp(self):
        ...
        self.test_data_path = os.path.join(os.path.dirname(__file__), "data", "test_vehicleclasses.json")
