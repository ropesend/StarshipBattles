...
class TestBuilderValidation(unittest.TestCase):
    ...
    def test_layer_restrictions(self):
        ...
        # Verify ARMOR layer usually has restriction (from game.simulation.entities.ship init)
...
from game.simulation.entities.ship_loader import initialize_ship_data
        ...
        from game.simulation.systems.validator import ShipDesignValidator
    ...
    def test_class_requirements(self):
        ...
        # It calculates totals from game.simulation.components.component.
        ...
        # But ShipDesignValidator imports VEHICLE_CLASSES from game.simulation.entities.ship.
