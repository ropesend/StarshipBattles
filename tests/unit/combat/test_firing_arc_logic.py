...
class TestFiringArcLogic:
    ...
    def test_forward_fire(self):
        ...
        assert result, "Target directly ahead should be in arc"
    ...
    def test_broadside_fire(self):
        ...
        assert result, "Target in broadside arc should be valid"

    def test_broadside_miss(self):
        # Scenario 3: Broadside Miss
        # Ship Left (180). Weapon Starboard (90). Total Up (270). Target Down (0, 100).
        result = self.check_arc(180, 90, 45, (0, 0), (0, 100))
        assert not result, "Target opposite to broadside should be invalid"
    ...
    def test_user_report_miss(self):
        ...
        assert not result, "Target out of side arc should be invalid"
    ...
    def test_half_angle_restriction(self):
        ...
        assert not result, "Target at 30 deg should be outside 45 deg total arc (+/-22.5)"
