...
from game.simulation.components.component import load_components, create_component, Component
...
class TestCombatEndurance:
    ...
    def test_energy_endurance_drain(self, base_ship):
        ...
        ship.add_component(beam, LayerType.OUTER)

        ship.recalculate_stats()

        # Net = 50 - 100 = -50
        assert ship.energy_consumption == 100.0
        assert ship.energy_net == -50.0
        assert ship.energy_endurance == 20.0  # 1000 / 50
    ...
    def test_energy_recharge(self, base_ship):
        ...
        assert ship.energy_endurance == float('inf')  # Positive net
    ...
    def test_standard_components_defaults(self, base_ship):
        ...
        r = ship.resources.get_resource("energy")
