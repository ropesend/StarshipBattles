...
class TestProjectileMovement:
    ...
    def test_projectile_update_moves_position(self):
        ...
        assert proj.position.x == pytest.approx(initial_pos.x + 10, abs=0.5)
        assert proj.position.y == pytest.approx(initial_pos.y + 5, abs=0.5)
...
class TestMissileGuidance:
    ...
    def test_missile_stops_tracking_dead_target(self):
        ...
        assert proj.velocity.x == pytest.approx(initial_vel.x, abs=0.5)
        assert proj.velocity.y == pytest.approx(initial_vel.y, abs=0.5)
