...
from game.simulation.components import Component, LayerType  # Phase 7: Removed Bridge, Armor, Weapon imports
...
class TestValidationGuardClauses:
    ...
    def test_mount_dependency_with_nonexistent_layer(self):
        ...
        try:
            ...
            assert result.is_valid, f"Should return valid for nonexistent layer. Errors: {result.errors}"
        finally:
            # Restore the layer
