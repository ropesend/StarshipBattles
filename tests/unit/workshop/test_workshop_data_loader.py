...
class TestWorkshopDataLoader(unittest.TestCase):
    ...
    def test_find_file_direct_match(self):
        ...
        loader = WorkshopDataLoader(self.custom_dir, default_data_dir=self.default_dir)
    ...
    def test_clear_registries_clears_registry_manager(self):
        ...
        loader = WorkshopDataLoader(self.custom_dir)
...
class TestWorkshopDataLoaderIntegration(unittest.TestCase):
    ...
    def test_load_all_with_real_data(self):
        ...
        loader = WorkshopDataLoader(self.data_dir)
