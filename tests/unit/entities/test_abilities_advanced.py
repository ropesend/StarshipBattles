...
class TestAbilitiesAdvanced:

    def test_firing_solution_arcs(self, mock_component):
        ...
        weapon = WeaponAbility(mock_component, data)
        ...
        assert weapon.check_firing_solution(ship_pos, ship_angle, target_pos)
        ...
        rad = math.radians(50)
        target_pos = pygame.math.Vector2(50 * math.cos(rad), 50 * math.sin(rad))
        assert not weapon.check_firing_solution(ship_pos, ship_angle, target_pos)
    ...
    def test_beam_accuracy_sigmoid(self, mock_component):
        ...
        beam = BeamWeaponAbility(mock_component, data)
    ...
    def test_weapon_damage_formula(self, mock_component):
