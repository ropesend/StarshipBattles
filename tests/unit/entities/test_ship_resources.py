...
from game.simulation.components import load_components, create_component, ComponentStatus
...
class TestShipResources:
    ...
    def test_resource_initialization(self):
        ...
        assert self.ship._resources_initialized is True
        assert self.ship.resources.get_value("fuel") == self.ship.resources.get_max_value("fuel")
        assert self.ship.resources.get_value("ammo") == self.ship.resources.get_max_value("ammo")
        ...
        self.ship.recalculate_stats()
        assert self.ship.resources.get_value("fuel") == 10
    ...
    def test_capacity_increase_refill(self):
        ...
        diff = max2 - max1
        assert self.ship.resources.get_value("fuel") == 50 + diff
