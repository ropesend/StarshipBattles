...
@pytest.fixture
def setup_game_data(fresh_registries):
...
class TestShipSerialization:
    ...
    def test_roundtrip_basic(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("TestShip", 0, 0, (100, 150, 200), team_id=2,
                    ship_class="Frigate", theme_id="Terran", registries=registries)
    ...
    def test_roundtrip_with_components(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("ComponentShip", 0, 0, (255, 255, 255), registries=registries)
    ...
    def test_roundtrip_with_modifiers(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("ModifierShip", 0, 0, (255, 255, 255), registries=registries)
    ...
    def test_roundtrip_preserves_resources(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("ResourceShip", 0, 0, (255, 255, 255), registries=registries)
        ...
        ship.add_component(create_component('generator', registries=registries), LayerType.CORE)
    ...
    def test_roundtrip_preserves_stats(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("StatsShip", 0, 0, (255, 255, 255), ship_class="Escort", registries=registries)

        # Add components that affect stats
        bridge = create_component('bridge', registries=registries)
        ship.add_component(bridge, LayerType.CORE)

        engine = create_component('engine', registries=registries)
    ...
    def test_layer_order_preserved(self, setup_game_data):
        ...
        registries = setup_game_data
        ship = Ship("OrderShip", 0, 0, (255, 255, 255), registries=registries)
