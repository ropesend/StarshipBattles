...
from game.ui.renderer.renderer import draw_ship, draw_hud
...
class TestRenderingLogic(unittest.TestCase):
    ...
    @patch('game.simulation.ships.ship_theme.ShipThemeManager') 
    ...
    def test_draw_hud_stats(self):
        """Verify HUD pulls stats from game.simulation.entities.ship properties."""
