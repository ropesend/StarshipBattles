...
class TestBuilderStructureFeatures(unittest.TestCase):
    def setUp(self):
        ...
        # Mock Builder GUI
        with patch('game.ui.screens.builder.main.BuilderLeftPanel'), \
             patch('game.ui.screens.builder.main.BuilderRightPanel'), \
             patch('game.ui.screens.builder.main.LayerPanel'), \
             patch('game.ui.screens.builder.main.ModifierEditorPanel'), \
             patch('game.ui.screens.builder.main.WeaponsReportPanel'):
