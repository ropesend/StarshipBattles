...
def _populated_planet() -> Planet:
    return Planet(
        ...
        stockpile={"metals": 250.0, "fuel": 100.0},
        max_stockpile={"metals": 5000.0, "fuel": 2000.0},
        staging_yard=[{"design_id": "fighter1", "design_data": {}, "mass": 50.0, "vehicle_type": "fighter", "name": "F1"}],
