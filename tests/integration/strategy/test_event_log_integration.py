...
class TestFacadeEventQueries:
    ...
    def test_facade_get_turn_events_specific_turn(self):
        ...
        with _EventHandlerGuard():
            ...
            log_event(EventType.COLONY_FOUNDED, category=EventCategory.COLONIES,
    ...
    def test_complex_built_event_visible_in_facade(self):
        ...
        with _EventHandlerGuard():
            ...
            log_event(EventType.COMPLEX_BUILT, category=EventCategory.PRODUCTION,
