...
def _run_battle(team1_ships, team2_ships, seed, max_ticks=500):
    ...
    engine.start(team1_ships, team2_ships, seed=seed)
...
class TestBattleDeterminism:
    ...
    def test_same_seed_same_outcome(self, fresh_registries):
        ...
        t1a, t2a = _make_teams(fresh_registries)
        winner1, ticks1, survivors1 = _run_battle(t1a, t2a, seed=42)

        t1b, t2b = _make_teams(fresh_registries)
        winner2, ticks2, survivors2 = _run_battle(t1b, t2b, seed=42)
