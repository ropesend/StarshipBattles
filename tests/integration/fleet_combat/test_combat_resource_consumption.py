...
class TestResourceRegistryIntegration:
    ...
    def test_resource_registry_tracks_multiple_resources(self):
        ...
        registry.register_storage(ResourceType.FUEL, 1000.0)
        registry.register_storage(ResourceType.ENERGY, 500.0)
        registry.register_storage(ResourceType.AMMO, 200.0)

        assert registry.get_max_value(ResourceType.FUEL) == 1000.0
        assert registry.get_max_value(ResourceType.ENERGY) == 500.0
        assert registry.get_max_value(ResourceType.AMMO) == 200.0
    ...
    def test_resource_registry_stacks_storage_from_multiple_components(self):
        ...
        # First reactor
        registry.register_storage(ResourceType.ENERGY, 100.0)
        # Second reactor
        registry.register_storage(ResourceType.ENERGY, 150.0)

        assert registry.get_max_value(ResourceType.ENERGY) == 250.0
    ...
    def test_resource_registry_stacks_generation_from_multiple_components(self):
        ...
        # First generator
        registry.register_generation(ResourceType.ENERGY, 5.0)
        # Second generator
        registry.register_generation(ResourceType.ENERGY, 3.0)

        resource = registry.get_resource(ResourceType.ENERGY)
    ...
    def test_resource_registry_reset_preserves_current_value(self):
        ...
        registry.register_storage(ResourceType.ENERGY, 100.0)
        registry.register_generation(ResourceType.ENERGY, 5.0)
        registry.set_value(ResourceType.ENERGY, 75.0)
...
class TestShipResourceConsumption:
    ...
    def test_ship_resources_initialized_from_components(self, fresh_registries):
        ...
        fuel_max = ship.resources.get_max_value(ResourceType.FUEL)
        energy_max = ship.resources.get_max_value(ResourceType.ENERGY)
    ...
    def test_ship_resource_consumption_reduces_current_value(self, fresh_registries):
        ...
        ship.resources.register_storage(ResourceType.ENERGY, 100.0)
        ship.resources.set_value(ResourceType.ENERGY, 100.0)

        initial = ship.resources.get_value(ResourceType.ENERGY)
        assert initial == 100.0

        # Consume energy
        resource = ship.resources.get_resource(ResourceType.ENERGY)
        success = resource.consume(30.0)

        assert success is True
        assert ship.resources.get_value(ResourceType.ENERGY) == 70.0
    ...
    def test_ship_resource_regeneration_per_tick(self, fresh_registries):
        ...
        ship.resources.register_storage(ResourceType.ENERGY, 100.0)
        ship.resources.register_generation(ResourceType.ENERGY, 10.0)  # 10/sec
        ship.resources.set_value(ResourceType.ENERGY, 50.0)
        ...
        assert ship.resources.get_value(ResourceType.ENERGY) == pytest.approx(expected, rel=0.001)
...
class TestCombatResourceFlow:
    ...
    def test_multiple_ticks_deplete_resources_with_no_regen(self, fresh_registries):
        ...
        registry.register_storage(ResourceType.ENERGY, 50.0)
        registry.set_value(ResourceType.ENERGY, 50.0)
    ...
    def test_regeneration_sustains_consumption_under_rate(self, fresh_registries):
        ...
        registry.register_storage(ResourceType.ENERGY, 100.0)
        registry.register_generation(ResourceType.ENERGY, 1000.0)  # Very high regen
        registry.set_value(ResourceType.ENERGY, 100.0)
    ...
    def test_fuel_depletes_during_continuous_movement(self, fresh_registries):
        ...
        # Limited fuel
        registry.register_storage(ResourceType.FUEL, 100.0)
        registry.set_value(ResourceType.FUEL, 100.0)

        fuel = registry.get_resource(ResourceType.FUEL)
    ...
    def test_ammo_depletes_during_weapon_firing(self, fresh_registries):
        ...
        # Limited ammo
        registry.register_storage(ResourceType.AMMO, 20.0)
        registry.set_value(ResourceType.AMMO, 20.0)

        ammo = registry.get_resource(ResourceType.AMMO)
...
class TestResourceDepletionEffects:
    ...
    def test_resource_check_before_action(self, fresh_registries):
        ...
        registry.register_storage(ResourceType.ENERGY, 10.0)
        registry.set_value(ResourceType.ENERGY, 10.0)

        energy = registry.get_resource(ResourceType.ENERGY)
    ...
    def test_zero_resource_blocks_consumption(self, fresh_registries):
        ...
        registry.register_storage(ResourceType.ENERGY, 100.0)
        registry.set_value(ResourceType.ENERGY, 0.0)
...
class TestResourceEdgeCases:
    ...
    def test_large_number_consumption(self, fresh_registries):
        ...
        # Large capacity
        registry.register_storage(ResourceType.ENERGY, 1_000_000.0)
        registry.set_value(ResourceType.ENERGY, 1_000_000.0)
