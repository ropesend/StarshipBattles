...
from battle_setup import load_ships_from_entries, scan_ship_designs, BattleSetupScreen
...
class TestFleetComposition(unittest.TestCase):
    ...
    @patch('battle_setup.Ship')
    @patch('battle_setup.filedialog.askopenfilename')
    @patch('battle_setup.tk.Tk')
    @patch('uuid.uuid4')
