...
class ShipStatsCalculator:
    ...
    def calculate(self, ship):
        ...
        for comp in component_pool:
            ...
            # Hangar stats (still uses VehicleLaunch ability from game.simulation.components.abilities dict)
    ...
    def calculate_ability_totals(self, components):
        """
        Calculate total values for all abilities from game.simulation.components.component.
