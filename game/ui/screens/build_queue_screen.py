...
class BuildQueueScreen:
    ...
    # -----------------------------------------------------------------------
    # Backward Compatibility Properties (for tests and legacy code)
    # -----------------------------------------------------------------------

    @property
    def queue_items(self):
        """Backward compatibility: queue_items now lives in renderer."""
        return self.renderer.queue_items

    @queue_items.setter
    def queue_items(self, value):
        """Backward compatibility: queue_items now lives in renderer."""
        self.renderer.queue_items = value

    @property
    def filter_panel(self):
        """Backward compatibility: filter_panel now lives in panels."""
        return self.panels.filter_panel

    @property
    def items_list_panel(self):
        """Backward compatibility: items_list_panel now lives in panels."""
        return self.panels.items_list_panel

    @property
    def planet_report(self):
        """Backward compatibility: planet_report now lives in panels."""
        return self.panels.planet_report

    @property
    def btn_close(self):
        """Backward compatibility: btn_close now lives in panels."""
        return self.panels.btn_close

    @property
    def btn_category_complex(self):
        """Backward compatibility: btn_category_complex now lives in panels."""
        return self.panels.btn_category_complex

    @property
    def btn_category_ship(self):
        """Backward compatibility: btn_category_ship now lives in panels."""
        return self.panels.btn_category_ship

    @property
    def btn_category_satellite(self):
        """Backward compatibility: btn_category_satellite now lives in panels."""
        return self.panels.btn_category_satellite

    @property
    def btn_category_fighter(self):
        """Backward compatibility: btn_category_fighter now lives in panels."""
        return self.panels.btn_category_fighter

    @property
    def background(self):
        """Backward compatibility: background now lives in panels."""
        return self.panels.background

    @property
    def items_scrollable(self):
        """Backward compatibility: items_scrollable now lives in panels."""
        return self.panels.items_scrollable

    @property
    def build_queue_panel(self):
        """Backward compatibility: build_queue_panel now lives in panels."""
        return self.panels.build_queue_panel

    @property
    def queue_scrollable(self):
        """Backward compatibility: queue_scrollable now lives in panels."""
        return self.panels.queue_scrollable

    @property
    def design_report(self):
        """Backward compatibility: design_report now lives in panels."""
        return self.panels.design_report
