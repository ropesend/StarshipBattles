...
class TestLabScene:
    ...
    def _on_back(self):
        ...
        # It has 'menu_buttons' list.
        # It has 'update_menu_buttons()'.
        # The original code had: self.game.menu_screen.create_particles()
        # app.py displayed: self._draw_menu uses plain fill.
        # So maybe 'menu_screen' attribute is gone or I just didn't see it?
        # app.py:96 # Menu UI -> self.update_menu_buttons()
        # app.py:97
        # app.py:287 -> self._draw_menu()
        # _draw_menu fills color.
        # So 'create_particles' call might be legacy from older main.py.
        # I will remove it to avoid AttributeError.
        
        # self.game.menu_screen.create_particles() # Removed legacy call
