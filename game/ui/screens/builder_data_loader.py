"""
BuilderDataLoader - Handles loading and reloading game data from a directory.

Extracted from BuilderSceneGUI._reload_data() for better testability and reusability.
"""
import os
...
class BuilderDataLoader:
    """
    Handles loading and reloading game data from a directory.
