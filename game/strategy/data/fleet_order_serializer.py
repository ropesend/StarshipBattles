"""
Fleet order serialization and deserialization.

Extracted from fleet.py (PROJ-210) to reduce complexity.
Handles 7 distinct target formats for FleetOrder persistence.
"""
...
class FleetOrderSerializer:
    """
    Handles serialization and deserialization of FleetOrder target values.
    ...
    def deserialize_orders(
        ...
        Returns:
            List of FleetOrder objects. Corrupt entries are skipped with warning.
        """
        orders = []
    ...
    @staticmethod
    def _deserialize_single_order(order_data: Dict[str, Any], index: int) -> FleetOrder:
        """
