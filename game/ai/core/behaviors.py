...
class FormationBehavior(AIBehavior):
    ...
    def update(self, target: Any, strategy: Dict[str, Any]) -> None:
        ...
        master = ship.get_formation_master()  # Returns raw Ship
        ...
        # Note: formation_offset is accessed via delegation (not in interface yet)
        ...
        ship_angle = ship.get_rotation()
        angle_diff = (master.angle - ship_angle + 180) % 360 - 180
        ...
        if dist <= drift_threshold:
            ...
            vec_to_spot = future_target_pos - ship_pos
...
class OrbitBehavior(AIBehavior):
    ...
    def update(self, target: Any, strategy: Dict[str, Any]) -> None:
        ...
        target_pos = ship_pos + move_dir * 200
