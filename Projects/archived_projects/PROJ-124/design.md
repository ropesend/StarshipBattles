...
### TCG-UI1-004: BattlePanels (ShipStatsPanel, SeekerMoni
- **Severity:** Critical
...
### TCG-UI2-002: game_renderer draw_ship lacks edge case
- **Severity:** Major
- **Location:** `game/ui/renderer/game_renderer`
- **Effort:** Medium

### TCG-UI2-003: draw_hud resource bar edge cases not tes
- **Severity:** Major
- **Location:** `game/ui/renderer/game_renderer`
- **Effort:** Medium
...
### TCG-UI2-005: ShipThemeManager missing scale factor bo
- **Severity:** Major
...
### TCG-UI2-006: Camera fit_objects edge case with dead t
- **Severity:** Minor
