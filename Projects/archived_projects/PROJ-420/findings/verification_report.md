...
|----|------|--------|----------|-----------:|----------------|----------|------------------|
| LEG-02-004 | `Multiple` | `_cached_registries / _ship_factory lazy-init blocks` | `shared helper (new) — e.g. `game/core/registry_cache.py::get_cached_registries()`` | 3 (intra-module) | consolidate_with | MINOR | — |
