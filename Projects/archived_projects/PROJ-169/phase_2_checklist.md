...
- [x] Verify zero imports for each file (search for filename without extension in codebase)
- [x] Delete `Tools/component_manager.py` (825 lines)
- [x] Delete `Tools/component_graphic_picker.py` (423 lines)
- [x] Delete `Tools/process_planet_images.py` (86 lines)
- [x] Delete `Tools/resize_components.py` (78 lines)
- [x] Delete `Tools/verify_accuracy_formula.py` (47 lines)
- [x] Delete `Tools/verify_cache.py` (41 lines)
- [x] Delete `Tools/verify_resources.py` (138 lines)
- [x] Delete `Tools/cleanup_pygame.py` (33 lines)
- [x] Delete `Tools/__init__.py` (empty file)
- [x] Do NOT delete `Tools/formation_editor.py` yet (Phase 3)
- [x] Do NOT delete `Tools/README.md` if it exists (may contain useful history)

**Notes:** All 9 files deleted. Verified zero imports via grep. formation_editor.py and README.md preserved for Phase 3.
...
- [x] Delete batch management script:
  - `scripts/manage_batches.py` (72 lines)

**Notes:** All 13 files deleted.
...
- [x] Delete entire `scripts/planet_qc/` directory:
...
- [x] Delete entire `scripts/planet_qc_v2/` directory:
  - `scripts/planet_qc_v2/server.py` (65 lines)

**Notes:** Both directories deleted.
