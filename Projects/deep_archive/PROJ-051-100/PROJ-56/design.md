...
2. **Strategy UI** (INLINE - SHOULD BE REPLACED)
   ...
   - Status: Inline HTML formatting, not reusable
...
4. **Colonize Planet Window** (BASIC - UPGRADE TO FULL PANEL)
   ...
   - Status: Text-only display via formatter callback
...
- Strategy UI violates architecture (duplicates panel logic inline)
