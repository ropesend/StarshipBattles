...
- [ ] Create directory `game/ui/filters/`
- [ ] Create `game/ui/filters/filter_state.py`:
  - `FilterState(Enum)` with values: `YES = "yes"`, `NO = "no"`, `IGNORE = "ignore"`
  - Class should be importable without pygame
- [ ] Create `game/ui/filters/__init__.py`:
  ```python
...
- [ ] Create test directory `tests/unit/ui/filters/`
- [ ] Create `tests/unit/ui/filters/__init__.py`
- [ ] Create `tests/unit/ui/filters/test_filter_state.py`:
...
- [ ] Verify: `pytest tests/unit/ui/filters/test_filter_state.py` passes
...
- [ ] Create `game/ui/filters/filter_state_manager.py`:
...
- [ ] Update `game/ui/filters/__init__.py` to export `FilterStateManager`
- [ ] Create `tests/unit/ui/filters/test_filter_state_manager.py`:
...
- [ ] Verify: `pytest tests/unit/ui/filters/` passes
...
- [ ] Verify no existing tests broken by new package creation
- [ ] Verify new tests are discovered and pass
...
- [ ] `game/ui/filters/` package exists with `FilterState` and `FilterStateManager`
- [ ] All new tests pass
