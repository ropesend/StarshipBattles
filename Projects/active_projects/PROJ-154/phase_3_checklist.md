...
**File:** `tests/unit/ui/test_battle_screen_extended.py` (131 lines)
...
- [ ] Clean up any fixtures/imports only used by removed tests (`setup_strategy_manager` fixture, `StrategyManager`, `get_unit_test_data_dir`, etc.)
...
**File:** `tests/unit/ui/test_scene_protocol.py` (240 lines)
...
**File:** `tests/unit/ui/screens/test_strategy_detail_formatter.py` (538 lines)
