...
### Task 3.2: TCG-UI1-002 - TestLabValidationManager has no unit tes [Complex]
**File:** `game/ui/screens/test_lab/valid`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.4: TCG-UI1-006 - FormationEditorScreen has incomplete tes [Medium]
**File:** `game/ui/screens/formation_edit`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/panels/ship_detail_pan`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.7: TCG-UI1-009 - BaseGallery abstract class has no unit t [Simple]
...
### Task 3.9: TCG-UI1-011 - Multiple builder submodules have no test [Complex]
...
### Task 3.10: TCG-UI1-012 - Multiple test_lab submodules have no tes [Complex]
...
### Task 3.13: TCG-UI1-015 - Workshop helper modules have thin covera [Medium]
...
**File:** `tests/unit/ui/screens/test_str`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.16: TCG-UI1-018 - DesignStatsPanel tests use bypass-init p [Medium]
**File:** `tests/unit/ui/panels/test_desi`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.17: TCG-UI1-019 - StrategyScreen tests have incomplete met [Medium]
**File:** `tests/unit/ui/screens/test_str`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/screens/strategy_input`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.20: TCG-UI1-022 - Source code inspection used instead of b [Simple]
**File:** `tests/unit/ui/screens/test_str`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.21: TCG-UI1-023 - Mock verification without assertions on [Simple]
**File:** `tests/unit/ui/screens/test_str`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.25: TCG-UI1-027 - Strategy screen + build queue integratio [Medium]
**File:** `Unknown`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 3.29: TCG-UI1-031 - No performance/stress tests for panels w [Medium]
**File:** `game/ui/panels/battle_panels.p`
**Tests:** `pytest tests/` (add appropriate test path)
