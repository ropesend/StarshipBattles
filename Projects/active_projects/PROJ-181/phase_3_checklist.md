...
- [ ] `test_ai.py:72` - Remove `RegistryManager.instance().clear()` from `ai_setup` fixture teardown
- [ ] `test_ai.py:201` - Remove `RegistryManager.instance().clear()` from `test_find_target` body
- [ ] `test_movement_and_ai.py:54` - Remove `RegistryManager.instance().clear()` from `movement_ai_setup` fixture teardown
...
- [ ] `test_builder_logic.py:24` - Remove `.clear()` from `setup_and_teardown` fixture teardown
- [ ] `test_selection_refinements.py:60` - Remove `.clear()` from `setup` fixture teardown
- [ ] `test_multi_selection_logic.py:57` - Remove `.clear()` from `setup` fixture teardown
- [ ] Remove `RegistryManager` import from each file if no longer used
...
- [ ] `test_component_decoupling.py:35,102,183` - Remove `.clear()` from all 3 fixture teardowns
- [ ] `test_simulation_design_loader.py:39,190` - Remove `.clear()` from both fixture teardowns
- [ ] Remove `RegistryManager` import from each file if no longer used
...
- [ ] `test_warnings.py:24` - Remove `.clear()` from `ship_with_registry` fixture teardown
- [ ] `test_bug_13_clear_removes_hull.py:21` - Remove `.clear()` from `simple_ship_registry` fixture setup
- [ ] `test_bug_13_clear_removes_hull.py:54` - Remove `.clear()` from `simple_ship_registry` fixture teardown
- [ ] Remove `RegistryManager` import from each file if no longer used
...
- [ ] Run `pytest tests/unit/ai/ tests/unit/builder/ tests/unit/simulation/ tests/unit/regressions/ tests/repro_issues/ -x` - all pass
