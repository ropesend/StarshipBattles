...
### Documentation
- [ ] Update [`docs/systems/`](../../../docs/systems/) with `satellites.md` describing the launch / recover / stationary-AI behavior.
- [ ] Update [`docs/systems/ability_reference.md`](../../../docs/systems/ability_reference.md) entries for `StrategicSatelliteLaunchAbility`, `TacticalSatelliteLaunchAbility`, `RecoverSatellitesAbility`.
