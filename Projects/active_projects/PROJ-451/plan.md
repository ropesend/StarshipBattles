...
|-------|--------|-----------|
| 1. RED — write the rounded-to-zero stall reproduction tests | Not Started | [phase_1_checklist.md](phase_1_checklist.md) |
...
**Next Action:** Run agent picks up PROJ-451 Phase 1 AFTER PROJ-449 closes (Group A serial order: PROJ-449 → PROJ-451 → PROJ-459 → PROJ-450).
