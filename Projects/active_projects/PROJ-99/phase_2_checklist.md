...
- [ ] Create new file `game/ui/panels/empire_treasury_panel.py`
- [ ] Import `pygame`, `pygame_gui`, `UIPanel`, `UILabel`, `UIImage`, `UIScrollingContainer`
- [ ] Import `PLANET_RESOURCES` from `game.core.constants`
- [ ] Import `Paths` from `game.core.paths`
- [ ] Define layout constants:
  - `LABEL_COL_WIDTH = 200`
  - `RESOURCE_COL_WIDTH = 120`
  - `ICON_SIZE = 20`
  - `ROW_HEIGHT = 28`
  - `SECTION_GAP = 15`
  - `HEADER_HEIGHT = 35`
- [ ] Define `EmpireTreasuryPanel` class:
...
- [ ] Implement `_build_resource_header(self, y)`:
...
- [ ] Implement `_build_section(self, title, rows, y)`:
...
- [ ] File `game/ui/panels/empire_treasury_panel.py` exists and has no syntax errors
