...
### Automated E2E
- [ ] `tests/integration/test_fms_c_e2e.py`:
...
### Stat correctness
- [ ] Verify `fighter_capacity` / `fighters_per_wave` / `launch_cycle` stats from [`launch.py:29-61`](../../../game/simulation/entities/stat_contributors/launch.py#L29) are correct after the Phase 1 stat-contributor update.
...
### Documentation
- [ ] Update [`docs/systems/`](../../../docs/systems/) with a new `fighters.md` describing the launch / recover lifecycle and ability surface.
- [ ] Update [`docs/systems/ability_reference.md`](../../../docs/systems/ability_reference.md) entries for `StrategicFighterLaunchAbility`, `TacticalFighterLaunchAbility`, `RecoverFightersAbility`.
