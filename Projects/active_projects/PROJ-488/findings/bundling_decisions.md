...
7 sibling projects as listed in the default proposal. Each project's `verification_report.md` records the specific items assigned to it. Run-wide REJECTED items (A-04, LEG-A-3, LEG-F-2) and OUT_OF_SCOPE items (the 12 audit-self-retracted findings) are documented in the next two sections.
