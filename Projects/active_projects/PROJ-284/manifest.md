...
| File | Type | Notes |
|------|------|-------|
| game/strategy/data/colony_species_config.py | Production (NEW) | Phase 1: per-colony per-species config dataclass |
| game/strategy/data/planet.py | Production (MODIFY) | Phase 1: adds `species_configs` field + serialization |
...
| tests/unit/strategy/data/test_colony_species_config.py | Test (NEW) | Phase 1 |
| tests/unit/strategy/data/test_planet.py | Test (MODIFY) | Phase 1: species_configs round-trip |
