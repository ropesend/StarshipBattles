...
|----|------|--------|----------|-----------:|----------------|----------|------------------|
| MIN-003 | `game/ui/screens/test_lab/test_run_details.py` | `TestRunDetailsPanel` | `game.ui.screens.test_lab.details` | 2 (panel_manager.py, results_panel.py) | migrate_callers_then_delete | MINOR | — |
