...
### Task 4.3: ADR-UI1-003 - God Class - TestLabScreen (1908 lines, 7 [Complex]
**File:** `game/ui/screens/test_lab/scree`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 4.4: ADR-UI1-004 - God Class - StrategyScreen (811 lines, 4 [Medium]
...
### Task 4.5: ADR-UI1-005 - God Class - BuilderMain (1121 lines, 44 [Medium]
...
**File:** `game/ui/screens/build_queue_sc`
**Tests:** `pytest tests/` (add appropriate test path)
...
### Task 4.7: ADR-UI1-007 - Circular Dependency Workarounds (Late Im [Medium]
...
### Task 4.8: ADR-UI1-008 - Private Attribute Access - StrategyEvent [Simple]
...
### Task 4.9: ADR-UI1-009 - Private Attribute Access - WorkshopEvent [Simple]
...
**File:** `game/ui/screens/workshop_scree`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/screens/planet_list_fi`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/screens/strategy_rende`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/screens/keybindings_sc`
**Tests:** `pytest tests/` (add appropriate test path)
...
**File:** `game/ui/screens/test_lab/test_`
**Tests:** `pytest tests/` (add appropriate test path)
