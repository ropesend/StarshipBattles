...
### ADR-STR-003: Galaxy Class Approaching God Class Statu
- **Severity:** Major
...
### PP-002: Incomplete God Class Decomposition
- **Severity:** Major
- **Location:** `game/ui/screens/test_lab/scree`
- **Effort:** Complex
...
### MOD-002: Mixed Responsibility in screen.py
- **Severity:** Minor
- **Location:** `game/ui/screens/test_lab/scree`
- **Effort:** Complex
