...
- [ ] `test_production_progress` (lines 61-76, 16 LOC) - Remove or implement — delete the dead test or add actual assertions; convert to pytest.skip if refactoring still needed.
...
### Task 1.3: `tests/integration/test_main_integration.py`
**File:** `tests/integration/test_main_integration.py`
**Tests:** `pytest tests/integration/test_main_integration.py`

- [ ] `test_import_main` (lines 26-35, 10 LOC) - Narrow except to ImportError; pytest.skip for non-import errors.
- [ ] Verify: `pytest tests/integration/test_main_integration.py` passes; LOC delta approximate 10
...
### Task 1.11: `tests/unit/simulation/test_simulation_constants.py`
**File:** `tests/unit/simulation/test_simulation_constants.py`
**Tests:** `pytest tests/unit/simulation/test_simulation_constants.py`

- [ ] `test_constants_exist` (lines 12-21, 10 LOC) - Remove only the 5 hasattr trivia; keep behavioral tests.
- [ ] Verify: `pytest tests/unit/simulation/test_simulation_constants.py` passes; LOC delta approximate 10
...
- [ ] `Public API contract tests` (lines 122-154, 33 LOC) - Keep as a contract guard but rename and document; consider moving to a lint step.
...
### Task 1.16: `tests/unit/strategy/services/test_intercept_edge_cases.py`
**File:** `tests/unit/strategy/services/test_intercept_edge_cases.py`
**Tests:** `pytest tests/unit/strategy/services/test_intercept_edge_cases.py`

- [ ] `3 import-existence tests` (lines 13-27, 27 LOC) - Delete entire file.
- [ ] Verify: `pytest tests/unit/strategy/services/test_intercept_edge_cases.py` passes; LOC delta approximate 27
...
### Task 1.20: `tests/unit/ui/panels/test_strategy_menu_panel.py`
...
- [ ] Verify: `pytest tests/unit/ui/panels/test_strategy_menu_panel.py` passes; LOC delta approximate 37
...
- [ ] `4 constant/hasattr tests` (lines 475-478, 488-491, 381-385, 387-390, 24 LOC) - Remove or consolidate into a single import-and-attribute smoke test.
- [ ] `2 facade hasattr tests` (lines 381-390, 10 LOC) - Remove or merge with behavioral facade tests.
- [ ] Verify: `pytest tests/unit/ui/screens/test_event_log_window.py` passes; LOC delta approximate 52
...
### Task 1.31: `tests/unit/ui/test_app_public_api.py`
**File:** `tests/unit/ui/test_app_public_api.py`
**Tests:** `pytest tests/unit/ui/test_app_public_api.py`

- [ ] `test_configure_logging_callable` (lines 123-128, 6 LOC) - Remove the test or replace with a meaningful contract assertion.
- [ ] Verify: `pytest tests/unit/ui/test_app_public_api.py` passes; LOC delta approximate 6
...
### Task 1.36: `tests/unit/ui/utils/test_race_asset_loader.py`
**File:** `tests/unit/ui/utils/test_race_asset_loader.py`
**Tests:** `pytest tests/unit/ui/utils/test_race_asset_loader.py`

- [ ] `test_load_portrait_full_has_correct_signature` (lines 85-93, 9 LOC) - Remove or replace with a behavioral call.
- [ ] Verify: `pytest tests/unit/ui/utils/test_race_asset_loader.py` passes; LOC delta approximate 9
