...
6. Save in `combat_lab/data/ships/` directory

## Related Files

- **Test Constants**: `combat_lab/test_constants.py` - Centralized values
- **Ship Files**: `combat_lab/data/ships/` - Actual test ship definitions
- **Components**: `combat_lab/data/components.json` - Weapon/armor definitions
