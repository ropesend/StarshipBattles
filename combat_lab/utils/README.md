...
```bash
python combat_lab/utils/test_log_analyzer.py
```
...
```bash
python combat_lab/utils/test_log_analyzer.py <TEST_ID>
```
...
**Example:**
```bash
python combat_lab/utils/test_log_analyzer.py BEAM360-001
```
...
Test executions are logged to `combat_lab/output/combat_lab_test_log.jsonl`.
