...
Usage:
    from combat_lab.logging_config import setup_combat_lab_logging, get_logger
...
def get_logger(name):
    ...
    # e.g., "CombatLab.combat_lab.runner"
