> **Status: In Progress**
> Scenario classes live in `combat_lab/scenarios/*_scenarios.py` and are
> run via `python -m combat_lab.run_tests`.
...
- All tests pass: `python -m combat_lab.run_tests`
...
- **Test Components**: `combat_lab/data/components.json`
- **Test Ships**: `combat_lab/data/ships/`
- **Test Scenarios**: `combat_lab/scenarios/*_scenarios.py`
- **Test Constants**: `combat_lab/test_constants.py`
- **Templates**: `combat_lab/scenarios/templates.py`
